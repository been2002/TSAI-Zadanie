        ...
        <form action="PHPCode/login.php" method="post">
            <div id="logNow">
                ...
                <div class="logowanielabel">
                    ...
                    <?php
                        $sprawdz_login = $_POST['login'];
                        $sprawdz_haslo = $_POST['haslo'];

                            $do_bazy = mysqli_connect('localhost','root','','tibijskimt2');
                            if(!$do_bazy){
                                exit("Nie udało się połaczyć do bazy!");
                            }
                        $zapytanie = mysqli_query($do_bazy,"SELECT Login,Haslo FROM uzytkownicy WHERE Login = '".$sprawdz_login."' AND Haslo = '".$sprawdz_haslo."'");
