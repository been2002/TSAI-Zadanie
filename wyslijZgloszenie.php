                ...
                <div class="topBar">
                    ...
                    <div class="contentAktualnosci">
                        ...
                        <?php
                            ...
                            if(!$do_bazy){
                                exit("Bład połaczenia z baza danych");
                            }
                            $supemail = $_POST['supportEmail'];
                            $supopis = $_POST['supportOpis'];
                            $dodaj = "INSERT INTO support VALUE (NULL,'$supemail','$supopis')";
                            $zapytanie = mysqli_query($do_bazy,$dodaj);
                            if(!$do_bazy == true){
                                echo "Ops, coś poszło nie tak!";
                            }else{
                                echo "Zgłoszenie zostało przeszłane i czeka na rozpatrzenie. Bądź cierpliwy Administracja TibijskiMT2";
                            }
